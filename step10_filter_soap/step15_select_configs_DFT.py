...
parser.add_argument('-s', "--sim_data", type=str, default="sim_matrix_min_max_soap_feat.txt", help="CSV file containing similarity data")
...
# Compute dissimilarity matrix RMSD

mols_num=len(mols)

data_min_max=pd.read_csv(args.sim_data, delim_whitespace=True)
