...
def function_to_optimize(inputs):
    ...
    mace_calc_found = MACECalculator(model_paths=[f'{main_path}/step4_iter1/refine_foundation/add_select_plus_distort/model_best.model'], device='cuda', default_dtype="float64")
